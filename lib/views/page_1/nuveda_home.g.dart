    ...
    return Material(
      ...
      child: Stack(children: [
        ...
        Positioned(
          left: 379.0,
          width: 108.0,
          top: MediaQuery.of(context).size.height * 0.666,
        ...
        Positioned(
          ...
          width: MediaQuery.of(context).size.width * 0.661,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 1.043,
          width: MediaQuery.of(context).size.width * 0.085,
          top: MediaQuery.of(context).size.height * 0.24,
          height: MediaQuery.of(context).size.height * 0.212,
          child: Image.asset(
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.549,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.584,
          width: MediaQuery.of(context).size.width * 0.027,
          top: MediaQuery.of(context).size.height * 0.431,
          height: MediaQuery.of(context).size.height * 0.005,
          child: Container(
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.656,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.909,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 1.149,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.093,
          width: MediaQuery.of(context).size.width * 0.288,
          top: MediaQuery.of(context).size.height * 0.719,
        ...
        Positioned(
          left: 286.0,
          width: 78.0,
          top: MediaQuery.of(context).size.height * 0.846,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.581,
          width: MediaQuery.of(context).size.width * 0.445,
          top: MediaQuery.of(context).size.height * 0.897,
          height: MediaQuery.of(context).size.height * 0.081,
          child: Container(
            width: MediaQuery.of(context).size.width * 0.445,
            height: MediaQuery.of(context).size.height * 0.081,
        ...
        Positioned(
          ...
          width: MediaQuery.of(context).size.width * 0.099,
          top: MediaQuery.of(context).size.height * 0.914,
          height: MediaQuery.of(context).size.height * 0.052,
          child: Image.asset(
        ...
        Positioned(
          ...
          top: MediaQuery.of(context).size.height * 0.809,
        ...
        Positioned(
          left: 36.0,
          width: 85.0,
          top: MediaQuery.of(context).size.height * 1.034,
        ...
        Positioned(
          left: 163.0,
          width: 97.0,
          top: MediaQuery.of(context).size.height * 1.201,
          height: MediaQuery.of(context).size.height * 0.017,
          child: Container(
              width: 97.000,
              height: MediaQuery.of(context).size.height * 0.017,
        ...
        Positioned(
          left: 53.0,
          width: 52.0,
          top: MediaQuery.of(context).size.height * 1.122,
        ...
        Positioned(
          left: 49.0,
          width: 59.891,
          top: MediaQuery.of(context).size.height * 1.037,
